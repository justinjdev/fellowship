...
- Posture: gate hooks (`gate-guard`, `gate-submit`, `gate-prereq`, `file-track`) fail *closed* so enforcement can't be silently skipped, but only where blocking is actually the safe answer. Precisely:
