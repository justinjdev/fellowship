...
2. **Reset quest state:** Run `~/.claude/fellowship/bin/fellowship init --dir $(pwd)` (you're already in the worktree) to clear `gate_pending` while preserving the current phase
