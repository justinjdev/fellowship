...
- The palantir spawn prompt in `plugin/skills/fellowship/resources/spawn-prompts.md` ↔ `plugin/agents/palantir.md` (the spawn prompt only carries context — quests, worktree paths, team name, cadence — and points at the agent definition for the monitoring checklist and alert format)
